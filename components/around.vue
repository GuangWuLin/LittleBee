...
export default {
    ...
    route:{
        data(t){
            this.schools = this.gardens.splice(0,10);
            t.next();
        }
    },
    methods: {
        ...
        onBottom(){
            // console.log(this.gardens.length);
            this.tmpArr = this.gardens.splice(0,10);
            this.schools = this.schools.concat(this.tmpArr);
            this.gardens.length || [this.show2 = true];
        }
    }
}
</script>
